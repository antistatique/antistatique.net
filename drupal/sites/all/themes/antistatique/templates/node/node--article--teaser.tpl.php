...
hide($content['links']);
if (!empty($content['field_co_author'])) {
...
<article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> article-teaser clearfix"<?php print $attributes; ?>>
  <p class="meta small">
    <span class="pull-right"><a href="<?php print url('node/'.$nid, array('absolute' => TRUE)); ?>#disqus_thread"><i aria-label="<?php print t('Comment');?>" class="fa fa-comment"></i></a></span>
